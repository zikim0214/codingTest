...
public class lessons_340213_동영상_재생기 {
    public static String solution(String video_len, String pos, String op_start, String op_end, String[] commands) {
        int videoLenInt = timeToSeconds(video_len);  // 동영상의 길이
        int posInt = timeToSeconds(pos); // 기능이 수행되기 직전의 재생위치
    ...
    private static int timeToSeconds(String timeStr) {
        int minuteToSecondsInt = Integer.parseInt(timeStr.split(":")[0]);
        int secondsToInt = Integer.parseInt(timeStr.split(":")[1]);
